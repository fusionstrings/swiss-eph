...
const GOLDEN_PLANETS: &[(c_int, &str, f64, f64, f64)] = &[
    ...
    (SE_PHOLUS, "Pholus", 281.23990347922802, 8.2013109027108424, 31.42992945485042),
    ...
    (SE_CUPIDO, "Cupido", 279.73420577190274, 0.54844019989275916, 41.778762238470456),
    (SE_HADES, "Hades", 104.68036862391993, -0.89436357551375723, 49.807287172130785),
    (SE_ZEUS, "Zeus", 206.31559368842761, -0.0082161550423202143, 59.255733194567995),
    (SE_KRONOS, "Kronos", 106.15214869753709, 0.015617021064542162, 63.890444113312412),
    (SE_APOLLON, "Apollon", 217.56899650697284, -0.010848348002033362, 70.526817550178336),
    (SE_ADMETOS, "Admetos", 64.330157104251157, 0.015553621796723189, 72.984876009591488),
    (SE_VULKANUS, "Vulkanus", 124.61298381418301, 0.012943124078247548, 76.28925142598861),
    (SE_POSEIDON, "Poseidon", 227.1793055649978, -0.012763013868434854, 84.054240196070765),
];
